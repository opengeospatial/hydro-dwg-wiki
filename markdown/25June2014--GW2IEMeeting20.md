# **<a href="GW2IE" class="wikilink">GW2IE</a> Meeting 20** **-- Wed 25 June 2014 -- Logical Model**
...
- GWML2 report
  - Will use <a href="WaterML2" class="wikilink">WaterML2</a> outline (as submitted by Bruce)
    - one document to contain all specs: conceptual model, logical model, requirements classes, conformance classes
    - adapt <a href="WaterML2" class="wikilink">WaterML2</a> outline for GWML2:
...
- Logical Model
  - well:<a href="LogValue" class="wikilink">LogValue</a>: to be manually added to XSD (to replace <a href="CV_ElementValuePair" class="wikilink">CV_ElementValuePair</a>)
...
. -- Main.<a href="BoyanBrodaric" class="wikilink">BoyanBrodaric</a> - 25 June 2014

- TOPICINFO{author="<a href="BoyanBrodaric" class="wikilink">BoyanBrodaric</a>" comment="reprev" date="1403722024" format="1.1" reprev="3" version="3"}
